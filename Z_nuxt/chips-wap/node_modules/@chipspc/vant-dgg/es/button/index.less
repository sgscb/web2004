...
.sp-button {
  ...
  &--spdanger {
    color: @button-spdanger-color;
    background-color: @button-spdanger-background-color;
    border: @button-border-width solid @button-spdanger-border-color;
  }

  &--spwarning {
    color: @button-spwarning-color;
    background-color: @button-spwarning-background-color;
    border: @button-border-width solid @button-spwarning-border-color;
  }
  ...
  &--hairline {
    ...
    &.sp-button--round::after {
      border-radius: @button-round-border-radius;
    }

    &.sp-button--square::after {
      border-radius: 0;
    }
  }
}
