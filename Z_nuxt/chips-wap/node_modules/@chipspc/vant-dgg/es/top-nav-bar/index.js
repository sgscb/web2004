...
import { BORDER_BOTTOM } from '../utils/constant'; // 按钮组件

import Icon from '../icon'; // 注入生成节点方法

var _createNamespace = createNamespace('top-nav-bar'),
  ...
  methods: {
    ...
    genNavBar: function genNavBar() {
      ...
      return h("div", {
        ...
        "class": [bem({
          fixed: this.fixed
        }), (_ref = {}, _ref[BORDER_BOTTOM] = this.border, _ref), bem({
