 ...
 */
var _createNamespace = (0, _utils.createNamespace)('bottombar-info'),
    createComponent = _createNamespace[0],
    bem = _createNamespace[1];

var _default = createComponent({
  mixins: [(0, _relation.ChildrenMixin)('SpBottombar')],
  props: {
    card: {
      type: Object
    },
  ...
  methods: {
    Avatar: function Avatar() {
      ...
      if (card.imgSrc) {
        var size = (0, _utils.addUnit)(card.avatarSize);
