...
var _createNamespace = (0, _utils.createNamespace)('center-popup'),
...
var _default2 = createComponent({
  mixins: [(0, _relation.ParentMixin)('vanCenterPopup'), (0, _popup.PopupMixin)()],
  props: {
  ...
  computed: {
    exitField: function exitField() {
      return (0, _extends2.default)({}, typeMap[this.field.type], this.field);
    },
    //设置说明style
  ...
  methods: {
    ...
    genButton: function genButton() {
      ...
      return h("div", {
        "class": isMore ? [bem('footer--multiple')] : [_constant.BORDER_TOP, bem('footer')]
      }, [showCancelButton && h(_button.default, {
        "attrs": {
          "size": "large",
          "text": exitField.cancelButtonText,
          "loading": exitField.cancelButtonLoading
        },
        "class": [bem('cancel'), (_ref = {}, _ref[_constant.BORDER_TOP] = isMore, _ref)],
        "style": {
      ...
      }), showConfirmButton && (exitField.confirmButtonText || exitField.confirmButtonText2) && h(_button.default, {
        "attrs": {
          "size": "large",
        ...
        "class": [bem('confirm'), (_ref2 = {}, _ref2[_constant.BORDER_LEFT] = multiple, _ref2), (_ref3 = {}, _ref3[_constant.BORDER_TOP] = isMore, _ref3)],
        "style": {
      ...
      }), showConfirmButton && exitField.confirmButtonText1 && h(_button.default, {
        "attrs": {
          "size": "large",
          "text": exitField.confirmButtonText1,
          "loading": exitField.confirmButtonLoading1
        },
        "class": [bem('confirm'), (_ref4 = {}, _ref4[_constant.BORDER_TOP] = isMore, _ref4)],
        "style": {
