(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("SP-Mobile", ["vue"], factory);
	else if(typeof exports === 'object')
		exports["SP-Mobile"] = factory(require("vue"));
	else
		root["SP-Mobile"] = factory(root["Vue"]);
...
__webpack_require__.d(__webpack_exports__, "BackToTop", function() { return /* reexport */ back_to_top; });
__webpack_require__.d(__webpack_exports__, "Bottombar", function() { return /* reexport */ bottombar; });
__webpack_require__.d(__webpack_exports__, "BottombarButton", function() { return /* reexport */ bottombar_button; });
__webpack_require__.d(__webpack_exports__, "BottombarIcon", function() { return /* reexport */ bottombar_icon; });
__webpack_require__.d(__webpack_exports__, "BottombarInfo", function() { return /* reexport */ bottombar_info; });
...
__webpack_require__.d(__webpack_exports__, "Card", function() { return /* reexport */ es_card; });
...
__webpack_require__.d(__webpack_exports__, "CenterPopup", function() { return /* reexport */ center_popup; });
...
__webpack_require__.d(__webpack_exports__, "Depreciate", function() { return /* reexport */ depreciate; });
...
__webpack_require__.d(__webpack_exports__, "NavSearch", function() { return /* reexport */ nav_search; });
...
__webpack_require__.d(__webpack_exports__, "PopupSp", function() { return /* reexport */ popup_sp; });
...
__webpack_require__.d(__webpack_exports__, "PulldownSort", function() { return /* reexport */ pulldown_sort; });
...
__webpack_require__.d(__webpack_exports__, "Safeguard", function() { return /* reexport */ safeguard; });
...
__webpack_require__.d(__webpack_exports__, "TopNavBar", function() { return /* reexport */ top_nav_bar; });
...
__webpack_require__.d(__webpack_exports__, "WorkCard", function() { return /* reexport */ work_card; });
__webpack_require__.d(__webpack_exports__, "WorkList", function() { return /* reexport */ work_list; });
__webpack_require__.d(__webpack_exports__, "WorkTab", function() { return /* reexport */ work_tab; });
__webpack_require__.d(__webpack_exports__, "WorkTabFilter", function() { return /* reexport */ work_tab_filter; });
__webpack_require__.d(__webpack_exports__, "WorkTabFilterItem", function() { return /* reexport */ work_tab_filter_item; });
__webpack_require__.d(__webpack_exports__, "WorkTabSort", function() { return /* reexport */ work_tab_sort; });
__webpack_require__.d(__webpack_exports__, "WorkTabSortItem", function() { return /* reexport */ work_tab_sort_item; });
__webpack_require__.d(__webpack_exports__, "WorkTabs", function() { return /* reexport */ work_tabs; });
    ...
    methods: {
      ...
      addLock: function addLock() {
        if (this.lockScroll) {
          ...
          if (!context_context.lockCount) {
            document.body.classList.add('sp-overflow-hidden');
          }
      ...
      removeLock: function removeLock() {
        if (this.lockScroll && context_context.lockCount) {
          ...
          if (!context_context.lockCount) {
            document.body.classList.remove('sp-overflow-hidden');
          }
        }
      },
...
/* harmony default export */ var popup = (popup_createComponent({
  ...
  methods: {
    ...
    genCancel: function genCancel() {
      ...
      return h("div", {
        ...
        "class": popup_bem('title--center--cancel')
      }, ["\u53D6\u6D88"]);
    },
    genSubmit: function genSubmit() {
      ...
      return h("div", {
        ...
        "class": popup_bem('title--center--submit')
      }, ["\u786E\u8BA4"]);
    },
    ...
    genTitle: function genTitle() {
      ...
      if (titleSlot || this.title) {
        if (this.titleType === 'left') {
          return h("div", {
            "class": popup_bem('title', this.titleType)
          }, [h("div", [this.slots('title') || this.title]), this.genCont()]);
        } else {
          return h("div", {
            "class": popup_bem('title', this.titleType)
          }, [this.genCancel(), h("div", {
            "class": popup_bem('title--center--title')
  ...
  render: function render() {
    ...
    }, [this.genTitle(), this.slots(), this.closeable && this.titleType !== 'center' && h(es_icon, {
      "attrs": {
        "role": "button",
        "tabindex": "0",
  ...
  function Header() {
    if (title) {
      return h("div", {
        ...
        "class": action_sheet_bem('header--title')
...
/* harmony default export */ var picker = (picker_createComponent({
  ...
  methods: {
    ...
    genTitle: function genTitle() {
      ...
      if (this.title) {
        return h("div", {
          "class": ['sp-ellipsis', picker_bem('title')]
        }, [this.title]);
      }
    },
...
function lockClick(lock) {
  if (lock) {
    if (!lockCount) {
      document.body.classList.add('sp-toast--unclickable');
    }
    ...
    if (!lockCount) {
      document.body.classList.remove('sp-toast--unclickable');
    }
  }
}
...
/* harmony default export */ var Dialog = (Dialog_createComponent({
  ...
  methods: {
    ...
    genIcon: function genIcon() {
      ...
      var iconName = this.iconName,
          ...
          iconPrefix = this.iconPrefix;
      return iconName && h("div", {
        "class": Dialog_bem('icon'),
        "style": {
          background: iconColor
        }
      }, [iconPrefix ? h(es_icon, {
        "attrs": {
          "name": iconName,
  ...
  render: function render() {
    ...
    }, [this.genIcon(), Title, this.genContent(title, messageSlot), this.theme === 'round-button' ? this.genRoundButtons() : this.genButtons()])]);
  }
}));
...
function Tag(h, props, slots, ctx) {
  ...
  return h("transition", {
    "attrs": {
      "name": props.closeable ? 'sp-fade' : null
    }
...
// CONCATENATED MODULE: ./es/back-to-top/index.js
// 引入常用工具
 // 按钮组件

 // 注入生成节点方法

var back_to_top_createNamespace = Object(create["a" /* createNamespace */])('back-to-top'),
    back_to_top_createComponent = back_to_top_createNamespace[0],
    back_to_top_bem = back_to_top_createNamespace[1];

/* harmony default export */ var back_to_top = (back_to_top_createComponent({
  props: {
    // 图标传入类型
    iconPrefix: String,
    //返回顶部按钮的icon
...
// CONCATENATED MODULE: ./es/bottombar/index.js
...
var bottombar_createNamespace = Object(create["a" /* createNamespace */])('bottombar'),
    bottombar_createComponent = bottombar_createNamespace[0],
    bottombar_bem = bottombar_createNamespace[1];

/* harmony default export */ var bottombar = (bottombar_createComponent({
  mixins: [ParentMixin('SpBottombar')],
  props: {
    //tabbar 选中效果
    value: {
      type: [Number, String],
  ...
  methods: {
    ...
    tabBarSlots: function tabBarSlots() {
      ...
      var h = this.$createElement; //默认属性和传入来的合并

      var tabBar = _extends({}, this.defaultProp, this.tabBar);
  ...
  render: function render() {
    var h = arguments[0]; //通过 tabBarData 的 length 判断是否渲染 tabbar 栏
...
// CONCATENATED MODULE: ./es/bottombar-button/index.js
...
var bottombar_button_createNamespace = Object(create["a" /* createNamespace */])('bottombar-button'),
    bottombar_button_createComponent = bottombar_button_createNamespace[0],
    bottombar_button_bem = bottombar_button_createNamespace[1];

/* harmony default export */ var bottombar_button = (bottombar_button_createComponent({
    ...
    buttonSlot: function buttonSlot() {
      ...
      if (!!slot) {
        var vnode = h("slot", [h("div", {
          "class": bottombar_button_bem('slot-top')
        }, [slot.top]), h("div", {
          "class": bottombar_button_bem('slot-bottom')
        }, [slot.bottom])]);
        return vnode;
      } else {
...
// CONCATENATED MODULE: ./es/bottombar-icon/index.js
...
var bottombar_icon_createNamespace = Object(create["a" /* createNamespace */])('bottombar-icon'),
    bottombar_icon_createComponent = bottombar_icon_createNamespace[0],
    bottombar_icon_bem = bottombar_icon_createNamespace[1];

/* harmony default export */ var bottombar_icon = (bottombar_icon_createComponent({
  mixins: [ChildrenMixin('SpBottombar')],
  props: _extends({}, routeProps, {
    iconClass: null,
    dot: Boolean,
  ...
  methods: {
    ...
    genIcon: function genIcon() {
      ...
      return h(es_icon, {
        "class": [bottombar_icon_bem('icon'), this.iconClass],
        "attrs": {
          "tag": "div",
          "dot": this.dot,
          "info": info,
...
// CONCATENATED MODULE: ./es/bottombar-info/index.js
/*
 * @Author: your name
 * @Date: 2020-10-09 16:35:48
...
var bottombar_info_createNamespace = Object(create["a" /* createNamespace */])('bottombar-info'),
    bottombar_info_createComponent = bottombar_info_createNamespace[0],
    bottombar_info_bem = bottombar_info_createNamespace[1];

/* harmony default export */ var bottombar_info = (bottombar_info_createComponent({
  mixins: [ChildrenMixin('SpBottombar')],
  props: {
    card: {
      type: Object
  ...
  methods: {
    Avatar: function Avatar() {
      ...
      if (card.imgSrc) {
        var size = Object(unit["a" /* addUnit */])(card.avatarSize);
        ...
        return h("div", {
          "class": bottombar_info_bem('avatar', {
            round: card.round
          }),
          "style": {
            width: size,
    ...
    Title: function Title() {
      ...
      var name = card.cardName ? h("div", {
        "class": bottombar_info_bem('card')
      }, [h("span", {
        "class": bottombar_info_bem('name')
      }, [card.cardName || '']), h(es_icon, {
        "attrs": {
          "tag": "span",
          "size": card.size,
          "name": card.icon || ''
      ...
      var sign = card.cardSign ? h("p", {
        "class": bottombar_info_bem('sign')
      }, [card.cardSign || '']) : '';
      return h("div", {
        "class": name && sign ? bottombar_info_bem('content') : ''
      }, [name, sign]);
    }
  },
  render: function render() {
...
function Card(h, props, slots, ctx) {
  ...
  function Title() {
    ...
    if (props.title) {
      return h("div", {
        "class": [card_bem('title'), 'sp-multi-ellipsis--l2']
      }, [props.title]);
    }
  }
  ...
  function Desc() {
    ...
    if (props.desc) {
      return h("div", {
        "class": [card_bem('desc'), 'sp-ellipsis']
      }, [props.desc]);
    }
  }
...
// CONCATENATED MODULE: ./es/center-popup/index.js
...
var center_popup_createNamespace = Object(create["a" /* createNamespace */])('center-popup'),
    center_popup_createComponent = center_popup_createNamespace[0],
    center_popup_bem = center_popup_createNamespace[1]; //弹框默认配置
...
/* harmony default export */ var center_popup = (center_popup_createComponent({
  ...
  methods: {
    ...
    genDescription: function genDescription() {
      ...
      return h("div", {
        "class": center_popup_bem('description'),
        "style": style
    ...
    genInfo: function genInfo(type) {
      ...
      return this.data.length !== 0 && this.data.map(function (item) {
        if (type === 'exit') {
          return h("div", {
            "class": center_popup_bem('item')
          }, [h("p", {
            "class": center_popup_bem('item--count')
          }, [item.count]), h("p", {
            "class": center_popup_bem('item--type')
          }, [item.type])]);
        }

        if (type === 'release') {
          return h("div", {
            "class": center_popup_bem('release')
          }, [h("p", {
            "class": center_popup_bem('release--resource')
          }, [item.count]), h("p", {
            "class": center_popup_bem('release--type')
    ...
    genButton: function genButton() {
      ...
      return h("div", {
        "class": isMore ? [center_popup_bem('footer--multiple')] : [BORDER_TOP, center_popup_bem('footer')]
      }, [showCancelButton && h(es_button, {
        "attrs": {
          "size": "large",
          "text": exitField.cancelButtonText,
          "loading": exitField.cancelButtonLoading
        },
        "class": [center_popup_bem('cancel'), (_ref = {}, _ref[BORDER_TOP] = isMore, _ref)],
        "style": {
      ...
      }), showConfirmButton && (exitField.confirmButtonText || exitField.confirmButtonText2) && h(es_button, {
        "attrs": {
          "size": "large",
        ...
        "class": [center_popup_bem('confirm'), (_ref2 = {}, _ref2[BORDER_LEFT] = multiple, _ref2), (_ref3 = {}, _ref3[BORDER_TOP] = isMore, _ref3)],
        "style": {
      ...
      }), showConfirmButton && exitField.confirmButtonText1 && h(es_button, {
        "attrs": {
          "size": "large",
          "text": exitField.confirmButtonText1,
          "loading": exitField.confirmButtonLoading1
        },
        "class": [center_popup_bem('confirm'), (_ref4 = {}, _ref4[BORDER_TOP] = isMore, _ref4)],
        "style": {
    ...
    genTypeContact: function genTypeContact() {
      ...
      return h("div", {
        ...
        "class": this.buttonType === 'button' ? center_popup_bem('container') : center_popup_bem('containerConfirm')
...
/* harmony default export */ var circle = (circle_createComponent({
  ...
  beforeCreate: function beforeCreate() {
    this.uid = "sp-circle-gradient-" + circle_uid++;
  },
  computed: {
    style: function style() {
...
// CONCATENATED MODULE: ./es/depreciate/index.js


var _createComponent; // Utils
...
var depreciate_createNamespace = Object(create["a" /* createNamespace */])('depreciate'),
    depreciate_createComponent = depreciate_createNamespace[0],
    depreciate_bem = depreciate_createNamespace[1],
    depreciate_t = depreciate_createNamespace[2];

var depreciate_defaultData = {
  code: '',
  tel: '',
  isDefault: false,
  show: true
...
function depreciate_isPostal(value) {
  return /^\d{6}$/.test(value);
}

/* harmony default export */ var depreciate = (depreciate_createComponent((_createComponent = {
  props: {
    //电话号码占位符
    ...
    messageInfo: {
      type: Object,
      default: function _default() {
        return _extends({}, depreciate_defaultData);
      }
    },
    //获取验证码的文本
    buttonText: String,
  ...
  watch: {
    messageInfo: {
      handler: function handler(val) {
        this.data = _extends({}, depreciate_defaultData, val);
      },
      deep: true,
      immediate: true
    }
  ...
  getErrorMessage: function getErrorMessage(key) {
    ...
    switch (key) {
      case 'code':
        return value ? '' : depreciate_t('nameEmpty');

      case 'tel':
        return this.telValidator(value) ? '' : depreciate_t('telInvalid');
    }
  },
  genFinish: function genFinish() {
    var h = this.$createElement;
    return h("div", {
      ...
      "class": depreciate_bem('code--count')
    }, [this.count, " s"])]);
  },
  ...
  var data = this.data,
      errorInfo = this.errorInfo;
  return h("div", {
    "class": depreciate_bem()
  }, [this.telJudge(), h("div", {
    "class": depreciate_bem('choose')
  }, [h("div", [h(es_checkbox, {
    "class": depreciate_bem('choose--radio'),
    "attrs": {
      "icon-size": "16px"
    },
    "model": {
    ...
    "class": depreciate_bem('choose--text')
  }, [h("div", [this.chooseInfo.text])])]), h("div", {
    "class": depreciate_bem('buttons')
  }, [h(es_button, {
    "attrs": {
      "block": true,
      "disabled": this.disabled,
...
// CONCATENATED MODULE: ./es/evaluate/index.js
...
var evaluate_createNamespace = Object(create["a" /* createNamespace */])('evaluate'),
    evaluate_createComponent = evaluate_createNamespace[0],
    evaluate_bem = evaluate_createNamespace[1];

/* harmony default export */ var evaluate = (evaluate_createComponent({
  props: {
    //按钮文字
    buttonText: String,
    //选中值
  ...
  render: function render() {
    ...
    var Options = this.options.map(function (option, index) {
      return h(col, {
        ...
        "class": [evaluate_bem('text'), _this.categoryIndex == index && evaluate_bem('active')]
      }, [h("span", {
        "class": _this.ellipsis && evaluate_bem('ellipsis')
      }, [option.text])])]);
    });
    return h("div", [h(row, {
      "attrs": {
      ...
      "class": evaluate_bem('field')
    }), h("div", {
      "class": evaluate_bem('buttons')
    }, [h(es_button, {
      "attrs": {
        "block": true,
        "loading": this.isSaving,
  ...
  methods: {
    ...
    genNavBar: function genNavBar() {
      ...
      return h("div", {
        ...
        "class": [nav_bar_bem('title'), 'sp-ellipsis']
...
// CONCATENATED MODULE: ./es/nav-search/index.js
...
var nav_search_createNamespace = Object(create["a" /* createNamespace */])('nav-search'),
    nav_search_createComponent = nav_search_createNamespace[0],
    nav_search_bem = nav_search_createNamespace[1],
    nav_search_t = nav_search_createNamespace[2];
...
function SearchSp(h, props, slots, ctx) {
  function Label() {
    function onHref() {
      ...
      functional_emit(ctx, 'on-click-label');
    }

    if (slots.label || props.label) {
      if (props.specialLabel) {
        return h("div", {
          "class": nav_search_bem('special'),
          "on": {
            "click": onHref
          }
        }, [h("span", [props.label]), h(es_icon, {
          "class": nav_search_bem('special__icon'),
          "attrs": {
            "name": "play",
            "size": "12"
          }
  ...
  function Action() {
    ...
    }, [slots.action ? slots.action() : props.actionText || nav_search_t('cancel')]);
  }

  function onSearch() {
    functional_emit(ctx, 'on-click-search');
  }
  ...
  return h("div", helper_default()([{
    "class": [nav_search_bem({
      'show-action': props.showAction
    }), props.border && nav_search_bem('border')],
    "style": {
      background: props.background
    }
  }, inheritData]), [slots.left == null ? void 0 : slots.left(), h("div", {
    "class": [nav_search_bem('content', props.shape), props.bgColor && nav_search_bem('bgColor')]
...
/* harmony default export */ var nav_search = (nav_search_createComponent(SearchSp));
  ...
  render: function render() {
    ...
    function hexToRgb(val, opacity) {
      ...
      if (/^#/g.test(val)) {
        ...
        b = val.slice(3, 5);
        c = val.slice(5, 7);
        res = 'rgba(' + parseInt(a, 16) + ',' + parseInt(b, 16) + ',' + parseInt(c, 16) + ',' + opacity + ')';
        return res;
      } else {
        return val;
      }
    ...
    var slots = this.slots,
        ...
        leftIconMinWidth = this.leftIconMinWidth;
    var barStyle = {
      color: this.color,
      background: this.background || hexToRgb(this.color, 0.1)
    };
    console.log(hexToRgb(this.color, 0.1));
    var contentStyle = {
    ...
    function ContentIcon() {
      ...
      if (contentIcon) {
        return h(es_icon, {
          ...
          "class": notice_bar_bem('content-icon')
        });
      }
    }
    ...
    return h("div", {
      ...
      "class": [notice_bar_bem('content'), {
        'sp-ellipsis': this.scrollable === false && !this.wrapable
      }],
      "style": contentStyle,
      "on": {
        "transitionend": this.onTransitionEnd
      }
    }, [ContentIcon(), this.slots() || this.text])]), RightIcon()]);
  }
}));
...
/* harmony default export */ var number_keyboard = (number_keyboard_createComponent({
  ...
  render: function render() {
    ...
    return h("transition", {
      "attrs": {
        "name": this.transition ? 'sp-slide-up' : ''
      }
    }, [h("div", {
      "directives": [{
        name: "show",
...
// CONCATENATED MODULE: ./es/popup-sp/index.js




var popup_sp_createNamespace = Object(create["a" /* createNamespace */])('popup-sp'),
    popup_sp_createComponent = popup_sp_createNamespace[0],
    popup_sp_bem = popup_sp_createNamespace[1];

/* harmony default export */ var popup_sp = (popup_sp_createComponent({
  mixins: [PopupMixin()],
  props: {
    round: Boolean,
    duration: [Number, String],
  ...
  methods: {
    ...
    genTitle: function genTitle() {
      ...
      if (titleSlot || this.title) {
        return h("div", {
          "class": popup_sp_bem('title')
        }, [h("span", [this.slots('title') || this.title]), this.genCont()]);
      }
    }
  },
  beforeCreate: function beforeCreate() {
  ...
  render: function render() {
    ...
    return h("transition", {
      ...
      "style": style,
      "class": popup_sp_bem((_bem = {
        round: round
      }, _bem[position] = position, _bem['safe-area-inset-bottom'] = this.safeAreaInsetBottom, _bem)),
      "on": {
        "click": this.onClick
      }
    }, [this.genTitle(), this.slots(), this.closeable && h(es_icon, {
      "attrs": {
        "role": "button",
        "tabindex": "0",
        "class-prefix": "sp-iconfont",
      ...
      "class": popup_sp_bem('close-icon', this.title ? 'top-right' : this.closeIconPosition),
      "on": {
        "click": this.close
      }
    })])]);
...
// CONCATENATED MODULE: ./es/pulldown-sort/index.js
 // Utils
...
var pulldown_sort_createNamespace = Object(create["a" /* createNamespace */])('pulldown-sort'),
    pulldown_sort_createComponent = pulldown_sort_createNamespace[0],
    pulldown_sort_bem = pulldown_sort_createNamespace[1];

/* harmony default export */ var pulldown_sort = (pulldown_sort_createComponent({
  mixins: [],
  props: {
    value: {
      type: Boolean,
  ...
  methods: {
    ...
    genOverall: function genOverall() {
      ...
      return this.data.map(function (item) {
        ...
        return h("div", {
          "class": isActive ? pulldown_sort_bem('overall_item') + ' active' : pulldown_sort_bem('overall_item'),
          "key": item.key,
          "attrs": {
            "data": item.key
          },
    ...
    genPrice: function genPrice() {
      ...
      return h("div", {
        "class": pulldown_sort_bem('category')
      }, [h("div", {
        "class": pulldown_sort_bem('category_body')
      }, [h("div", {
        "class": pulldown_sort_bem('category_item')
      }, [h("h4", ["\u4EF7\u683C\u533A\u95F4"]), h("div", {
        "class": pulldown_sort_bem('category_item-content')
        ...
        "class": pulldown_sort_bem('category_footer')
      }, [h(es_button, {
        "on": {
          "click": function click() {
...
// CONCATENATED MODULE: ./es/safeguard/index.js



var safeguard_createNamespace = Object(create["a" /* createNamespace */])('safeguard'),
    safeguard_createComponent = safeguard_createNamespace[0],
    safeguard_bem = safeguard_createNamespace[1];

/* harmony default export */ var safeguard = (safeguard_createComponent({
  props: {
    //标题
    title: String,
    //标题下的介绍文本
  ...
  render: function render() {
    ...
    var Options = this.options.map(function (option) {
      return h("li", {
        ...
        "class": safeguard_bem('icon')
      }, [h(es_icon, {
        "attrs": {
          "class-prefix": _this.iconPrefix,
          "name": option.icon
        },
        "class": safeguard_bem('color')
      })]), h("div", {
        "class": safeguard_bem('cont')
      }, [h("div", {
        "class": [safeguard_bem('title'), _this.ellipsis && safeguard_bem('ellipsis')]
      }, [option.title]), h("div", {
        "class": safeguard_bem('text')
      }, [option.text])])]);
    });
    return h("ul", {
      "class": safeguard_bem('list')
    }, [Options]);
  }
}));
...
function Search(h, props, slots, ctx) {
  ...
  return h("div", helper_default()([{
    ...
    "style": {
      backgroundColor: props.searchBgc
    },
...
/* harmony default export */ var SkuRowItem = (SkuRowItem_createComponent({
  ...
  render: function render() {
    ...
    return h("span", {
      ...
      "class": {
        'sp-multi-ellipsis--l2': this.largeImageMode
      }
...
/* harmony default export */ var SkuRowPropItem = (SkuRowPropItem_createComponent({
  ...
  render: function render() {
    var h = arguments[0];
    return h("span", {
      "class": ['sp-sku-row__item', {
        'sp-sku-row__item--active': this.choosed
      }],
      "on": {
        "click": this.onSelect
      }
    }, [h("span", {
      "class": "sp-sku-row__item-name"
    }, [this.skuValue.name])]);
  }
}));
...
/* harmony default export */ var SkuStepper = (SkuStepper_createComponent({
  ...
  render: function render() {
    ...
    var h = arguments[0];
    return h("div", {
      "class": "sp-sku-stepper-stock"
    }, [h("div", {
      "class": "sp-sku__stepper-title"
  ...
  methods: {
    ...
    genPreviewItem: function genPreviewItem(item, index) {
      ...
      var Preview = isImageFile(item) ? h(es_image, {
        ...
        "class": [uploader_bem('file-name'), 'sp-ellipsis']
...
/* harmony default export */ var Sku = (Sku_createComponent({
  ...
  computed: {
    skuGroupClass: function skuGroupClass() {
      return ['sp-sku-group-container', {
        'sp-sku-group-container--hide-soldout': !this.showSoldoutSku
      }];
    },
  ...
  render: function render() {
    ...
    var Header = slots('sku-header') || h(components_SkuHeader, {
      ...
      "class": "sp-sku__goods-price"
    }, [h("span", {
      "class": "sp-sku__price-symbol"
    }, ["\uFFE5"]), h("span", {
      "class": "sp-sku__price-num"
    }, [price]), this.priceTag && h("span", {
      "class": "sp-sku__price-tag"
...
// CONCATENATED MODULE: ./es/tooltip/index.js
...
var tooltip_createNamespace = Object(create["a" /* createNamespace */])('tooltip'),
    tooltip_createComponent = tooltip_createNamespace[0],
    tooltip_bem = tooltip_createNamespace[1];

/* harmony default export */ var tooltip = (tooltip_createComponent({
  props: _extends({}, routeProps, {
    //路由跳转属性 url to replace
    popperClass: String,
    //弹层class
  ...
  methods: {
    ...
    genContent: function genContent() {
      ...
      return h("div", {
        "class": tooltip_bem('list')
      }, [menuList && menuList.map(function (item) {
        return h("div", {
          "class": [tooltip_bem('item'), item.disable ? 'disable' : ''],
          "on": {
            "click": function click(event) {
          ...
          "class": tooltip_bem('item--content')
        }, [item.content])]);
      })]);
    },
    ...
    genSlots: function genSlots() {
      ...
      this.$nextTick(function () {
        ...
        event_on(_this4.getElm, 'click', _this4.openPopover);
        event_on(document, 'click', _this4.hidePopover);
      });
      return slot;
    },
   ...
   */
  beforeDestroy: function beforeDestroy() {
    off(this.getElm, 'click', this.openPopover);
    off(document, 'click', this.hidePopover);
  },
  render: function render() {
    var h = arguments[0];
    ...
    return h("div", {
      ...
      "ref": "popover",
      "class": [popperClass, tooltip_bem('show')],
      "style": {
        width: this.width,
        position: 'absolute'
      },
...
// CONCATENATED MODULE: ./es/top-nav-bar/index.js
// 引入常用工具
...
var top_nav_bar_createNamespace = Object(create["a" /* createNamespace */])('top-nav-bar'),
    top_nav_bar_createComponent = top_nav_bar_createNamespace[0],
    top_nav_bar_bem = top_nav_bar_createNamespace[1];

/* harmony default export */ var top_nav_bar = (top_nav_bar_createComponent({
  props: {
    //是否有padding
    padding: Boolean,
    // 标题
  ...
  methods: {
    ...
    genLeft: function genLeft() {
      ...
      if (leftSlot) {
        return h("div", {
          "ref": "left",
          "class": this.specialLayout ? top_nav_bar_bem('special--left') : top_nav_bar_bem('left'),
          "on": {
            "click": this.onClickLeft
          }
        }, [leftSlot]);
      ...
      if (this.leftText || this.leftArrow) {
        ...
        }, [[this.leftArrow && h(es_icon, {
          "class": top_nav_bar_bem('arrow'),
          "attrs": {
            "class-prefix": "sp-iconfont",
            "name": "back"
          }
        }), this.leftText && h("span", {
          "class": top_nav_bar_bem('text')
        }, [this.leftText])]]);
      }
    },
    ...
    genTitle: function genTitle(acas) {
      ...
      if (titleSlot || this.title) {
        return h("div", {
          ...
          "class": [this.specialLayout ? top_nav_bar_bem('special--title') : top_nav_bar_bem('title'), this.ellipsis && top_nav_bar_bem('ellipsis')]
    ...
    genRight: function genRight() {
      ...
      if (rightSlot) {
        return h("div", {
          "ref": "right",
          "class": this.specialLayout ? top_nav_bar_bem('special--right') : top_nav_bar_bem('right'),
          "on": {
            "click": this.onClickRight
          }
        }, [rightSlot]);
    ...
    genNavBar: function genNavBar() {
      ...
      return h("div", {
        ...
        "class": [top_nav_bar_bem({
          fixed: this.fixed
        }), (_ref = {}, _ref[BORDER_BOTTOM] = this.border, _ref), top_nav_bar_bem({
  ...
  render: function render() {
    ...
    if (this.placeholder && this.fixed) {
      return h("div", {
        "class": top_nav_bar_bem('placeholder'),
        "style": {
          height: this.height + "px"
        }
      }, [this.genNavBar()]);
...
function TreeSelect(h, props, slots, ctx) {
  ...
  function Content() {
    ...
    return subItems.map(function (item) {
      return h("div", {
        "key": item.id,
        "class": ['sp-ellipsis', tree_select_bem('item', {
...
// CONCATENATED MODULE: ./es/work-card/index.js





var work_card_createNamespace = Object(create["a" /* createNamespace */])('work-card'),
    work_card_createComponent = work_card_createNamespace[0],
    work_card_bem = work_card_createNamespace[1];

/* harmony default export */ var work_card = (work_card_createComponent({
  props: {
    //不同布局开关
    layout: {
      type: Boolean,
  ...
  methods: {
    ...
    genLeft: function genLeft() {
      ...
      if (!layout) {
        ...
        return h("div", {
          "class": work_card_bem('left')
        }, [this.genTitle(), this.genImg(), h("div", {
          "class": work_card_bem('bottom')
        }, [this.value && h("div", {
          "class": work_card_bem('bottom--value')
        }, [this.numberFilter, this.valueText]), this.favour && h("div", {
          "class": [work_card_bem('bottom--favour'), (_ref = {}, _ref[this.favour.activeClass] = this.favour.isFavour, _ref)],
          "on": {
            "click": this.onFavour
          }
        }, [h(es_icon, {
        ...
        return h("div", {
          ...
          "class": [work_card_bem('bottom--favour'), (_ref2 = {}, _ref2[this.favour.activeClass] = this.favour.isFavour, _ref2)],
          "on": {
            "click": this.onFavour
          }
        }, [h(es_icon, {
  ...
  render: function render() {
    var h = arguments[0];
    return h("div", {
      "class": work_card_bem('warp')
    }, [this.genLeft(), this.genRight()]);
  }
}));
// CONCATENATED MODULE: ./es/work-list/index.js




var work_list_createNamespace = Object(create["a" /* createNamespace */])('work-list'),
    work_list_createComponent = work_list_createNamespace[0],
    work_list_bem = work_list_createNamespace[1];

/* harmony default export */ var work_list = (work_list_createComponent({
  props: {
    //是否是有边框布局
    border: {
      type: Boolean,
  ...
  methods: {
    ...
    genTitle: function genTitle() {
      ...
      if (this.title || title) {
        return h("div", {
          "class": work_list_bem('title'),
          "on": {
            "click": this.onClick
          }
        }, [h("div", {
          "class": [work_list_bem('title--text'), this.border && work_list_bem('ellipsis')]
        }, [this.titleTag && this.titleTag.text && h("div", {
          "class": work_list_bem('title--tag')
        }, [h(es_tag, {
          "attrs": {
    ...
    genLabel: function genLabel() {
      ...
      if (this.labelList.length > 0) {
        return h("ul", {
          "class": work_list_bem('label-list')
        }, [List]);
      }
    },
    ...
    genSales: function genSales() {
      ...
      if (this.sales) {
        if (this.sales.layout) {
          return h("div", {
            "class": work_list_bem('money--right')
    ...
    genMoney: function genMoney() {
      ...
      if (this.money) {
        var money = h("div", {
          "class": work_list_bem('money--left')
        }, [h("span", {
          "style": {
    ...
    genListTag: function genListTag() {
      ...
      var List = this.options.list.map(function (option) {
        return h("li", [h("div", [option.title]), h("div", {
          "class": work_list_bem('ellipsis')
        }, [option.text])]);
      });

      if (this.options.type === 'one') {
        return h("ul", {
          "class": work_list_bem('list--tag--one')
        }, [List]);
      } else if (this.options.type === 'two') {
        return h("ul", {
          "class": work_list_bem('list--tag--two')
        }, [List]);
      } else if (this.options.type === 'three') {
        return h("ul", {
          "class": work_list_bem('list--tag--three')
        }, [List]);
      } else {
        var _List = this.options.list.map(function (option) {
          return h("div", [h(es_image, {
            "attrs": {
              "src": option.title,
              "width": "15",
              "height": "15"
        ...
        return h("div", {
          "class": work_list_bem('list--tag--four')
        }, [_List]);
      }
    }
  },
...
// CONCATENATED MODULE: ./es/work-tab/index.js





var work_tab_createNamespace = Object(create["a" /* createNamespace */])('work-tab'),
    work_tab_createComponent = work_tab_createNamespace[0],
    work_tab_bem = work_tab_createNamespace[1];

/* harmony default export */ var work_tab = (work_tab_createComponent({
  ...
  render: function render(h) {
    ...
    if (parent.animated) {
      return this.needContent && h("div", {
        ...
        "class": work_tab_bem('pane-wrapper', {
          inactive: !isActive
        })
      }, [h("div", {
        "class": work_tab_bem('pane')
      }, [Content])]);
    }
...
// CONCATENATED MODULE: ./es/work-tab-filter/index.js



var work_tab_filter_createNamespace = Object(create["a" /* createNamespace */])('work-tab-filter'),
    work_tab_filter_createComponent = work_tab_filter_createNamespace[0],
    work_tab_filter_bem = work_tab_filter_createNamespace[1];

/* harmony default export */ var work_tab_filter = (work_tab_filter_createComponent({
  ...
  render: function render() {
    var h = arguments[0];
    return h("div", {
      "class": work_tab_filter_bem()
    }, [this.slots()]);
  }
}));
// CONCATENATED MODULE: ./es/work-tab-filter-item/index.js
// Utils
 // Mixins



var work_tab_filter_item_createNamespace = Object(create["a" /* createNamespace */])('work-tab-filter-item'),
    work_tab_filter_item_createComponent = work_tab_filter_item_createNamespace[0],
    work_tab_filter_item_bem = work_tab_filter_item_createNamespace[1];

/* harmony default export */ var work_tab_filter_item = (work_tab_filter_item_createComponent({
  mixins: [ChildrenMixin('SpWorkTabFilter')],
  props: {},
  data: function data() {
    return {
      active: false
  ...
  methods: {
    handleItemClick: function handleItemClick() {
      this.parent.onChange(this.slots()[0].text, this.name || this.index);
      this.parent.itemIndex = this.index;
    }
  },
  render: function render() {
    var h = arguments[0];
    return h("div", {
      "class": work_tab_filter_item_bem({
        active: this.active
      }),
      "on": {
      ...
      "class": work_tab_filter_item_bem('item')
    }, [this.slots(), h("span", {
      "class": work_tab_filter_item_bem('span')
    })])]);
  }
}));
// CONCATENATED MODULE: ./es/work-tab-sort/index.js

 // 创建命名空间

var work_tab_sort_createNamespace = Object(create["a" /* createNamespace */])('work-tab-sort'),
    work_tab_sort_createComponent = work_tab_sort_createNamespace[0],
    work_tab_sort_bem = work_tab_sort_createNamespace[1]; // 创建组件


/* harmony default export */ var work_tab_sort = (work_tab_sort_createComponent({
  // 声明本组件是父节点和组件名称
  mixins: [ParentMixin('SpWorkTabSort')],
  props: {
    value: {
      // 获取默认选中值
      type: Object,
  ...
  render: function render() {
    var h = arguments[0]; // 返回组件

    return h("div", {
      "class": work_tab_sort_bem()
    }, [this.slots()]);
  }
}));
// CONCATENATED MODULE: ./es/work-tab-sort-item/index.js
// Utils
 // Mixins
...
var work_tab_sort_item_createNamespace = Object(create["a" /* createNamespace */])('work-tab-sort-item'),
    work_tab_sort_item_createComponent = work_tab_sort_item_createNamespace[0],
    work_tab_sort_item_bem = work_tab_sort_item_createNamespace[1]; // 创建子组件


/* harmony default export */ var work_tab_sort_item = (work_tab_sort_item_createComponent({
  ...
  render: function render() {
    var h = arguments[0]; // 返回子组件

    return h("div", {
      "class": work_tab_sort_item_bem({
      ...
      "class": work_tab_sort_item_bem('item')
    }, [this.slots(), h("span", {
      "class": work_tab_sort_item_bem('span')
    }, [h(es_icon, {
      "attrs": {
        "name": "play"
      },
      "class": work_tab_sort_item_bem('icon')
    })])])]);
  }
}));
// CONCATENATED MODULE: ./es/work-tabs/utils.js


var utils_scrollLeftRafId;
function utils_scrollLeftTo(scroller, to, duration) {
  Object(raf["a" /* cancelRaf */])(utils_scrollLeftRafId);
  var count = 0;
  var from = scroller.scrollLeft;
  var frames = duration === 0 ? 1 : Math.round(duration * 1000 / 16);
  ...
  function animate() {
    ...
    if (++count < frames) {
      utils_scrollLeftRafId = Object(raf["c" /* raf */])(animate);
    }
  }

  animate();
}
function utils_scrollTopTo(scroller, to, duration, callback) {
  var current = getScrollTop(scroller);
  var isDown = current < to;
  var frames = duration === 0 ? 1 : Math.round(duration * 1000 / 16);
  var step = (to - current) / frames;
...
// CONCATENATED MODULE: ./es/work-tabs/Title.js



var work_tabs_Title_createNamespace = Object(create["a" /* createNamespace */])('work-tab'),
    work_tabs_Title_createComponent = work_tabs_Title_createNamespace[0],
    work_tabs_Title_bem = work_tabs_Title_createNamespace[1];

/* harmony default export */ var work_tabs_Title = (work_tabs_Title_createComponent({
  props: {
    dot: Boolean,
    type: String,
    info: [Number, String],
  ...
  computed: {
    style: function style() {
      ...
      var isSimple = this.type === 'simple';
      var isSmall = this.type === 'small'; // card theme color

      if (color && (isCard || isSimple || isSmall)) {
        style.borderColor = color;
  ...
  methods: {
    ...
    genText: function genText() {
      var h = this.$createElement;
      var Text = h("span", {
        "class": work_tabs_Title_bem('text', {
          ellipsis: !this.scrollable
        })
      }, [this.slots() || this.title]);
      ...
      if (this.dot || Object(utils["c" /* isDef */])(this.info) && this.info !== '') {
        return h("span", {
          "class": work_tabs_Title_bem('text-wrapper')
        }, [Text, h(es_info, {
          "attrs": {
            "dot": this.dot,
            "info": this.info
...
// CONCATENATED MODULE: ./es/work-tabs/Content.js




var work_tabs_Content_createNamespace = Object(create["a" /* createNamespace */])('work-tabs'),
    work_tabs_Content_createComponent = work_tabs_Content_createNamespace[0],
    work_tabs_Content_bem = work_tabs_Content_createNamespace[1];

var Content_MIN_SWIPE_DISTANCE = 50;
/* harmony default export */ var work_tabs_Content = (work_tabs_Content_createComponent({
  mixins: [TouchMixin],
  props: {
    //标签个数
    count: Number,
  ...
  methods: {
    ...
    onTouchEnd: function onTouchEnd() {
      ...
      if (direction === 'horizontal' && this.offsetX >= Content_MIN_SWIPE_DISTANCE) {
        /* istanbul ignore else */
        if (deltaX > 0 && currentIndex !== 0) {
          this.$emit('change', currentIndex - 1);
        } else if (deltaX < 0 && currentIndex !== this.count - 1) {
    ...
    genChildren: function genChildren() {
      ...
      if (this.animated) {
        return h("div", {
          "class": work_tabs_Content_bem('track'),
          "style": this.style
        }, [this.slots()]);
      }
  ...
  render: function render() {
    var h = arguments[0];
    return h("div", {
      "class": work_tabs_Content_bem('content', {
        animated: this.animated
      }),
      "on": _extends({}, this.listeners)
    }, [this.genChildren()]);
...
// CONCATENATED MODULE: ./es/work-tabs/index.js
// Utils
...
var work_tabs_createNamespace = Object(create["a" /* createNamespace */])('work-tabs'),
    work_tabs_createComponent = work_tabs_createNamespace[0],
    work_tabs_bem = work_tabs_createNamespace[1];

/* harmony default export */ var work_tabs = (work_tabs_createComponent({
  mixins: [ParentMixin('SpWorkTabs'), BindEventMixin(function (bind) {
    if (!this.scroller) {
      this.scroller = getScroller(this.$el);
    }
  ...
  methods: {
    ...
    setLine: function setLine() {
      ...
      this.$nextTick(function () {
        ...
        if (!titles || !titles[_this3.currentIndex] || isHidden(_this3.$el)) {
          return;
        }
    ...
    scrollIntoView: function scrollIntoView(immediate) {
      ...
      var title = titles[this.currentIndex].$el;
      var to = title.offsetLeft - (nav.offsetWidth - title.offsetWidth) / 2;
      utils_scrollLeftTo(nav, to, immediate ? 0 : +this.duration);
    },
    onSticktScroll: function onSticktScroll(params) {
      this.stickyFixed = params.isFixed;
      this.$emit('scroll', params);
    ...
    scrollToCurrentContent: function scrollToCurrentContent(immediate) {
      ...
      if (this.scrollspy) {
        ...
        if (el) {
          var to = scroll_getElementTop(el, this.scroller) - this.scrollOffset;
          this.lockScroll = true;
          utils_scrollTopTo(this.scroller, to, immediate ? 0 : +this.duration, function () {
            _this6.lockScroll = false;
          });
        }
      }
  ...
  render: function render() {
    ...
    var Wrap = h("div", {
      "ref": "wrap",
      "class": [work_tabs_bem('wrap', {
        scrollable: scrollable
      }), (_ref = {}, _ref[BORDER_TOP_BOTTOM] = type === 'line' && this.border, _ref)]
    }, [this.mask && h("div", {
      "class": work_tabs_bem('mask')
    }), h("div", {
      "ref": "nav",
      "attrs": {
        "role": "tablist"
      },
      "class": work_tabs_bem('nav', [type, {
        complete: this.scrollable
      }, {
        navtab: this.isNavTab
      }]),
      "style": this.navStyle
    }, [this.slots('nav-left'), Nav, type === 'line' && h("div", {
      "class": work_tabs_bem('line'),
      "style": this.lineStyle
    }), this.slots('nav-right')])]);
    return h("div", {
      "class": work_tabs_bem([type])
    }, [this.sticky ? h(es_sticky, {
      "attrs": {
        "container": this.$el,
        "offsetTop": this.offsetTop
...
function install(Vue) {
  var components = [action_sheet, address_edit, address_list, es_area, back_to_top, bottombar, bottombar_button, bottombar_icon, bottombar_info, es_button, calendar, es_card, cell, cell_group, center_popup, es_checkbox, checkbox_group, circle, col, collapse, collapse_item, contact_card, contact_edit, contact_list, count_down, es_coupon, coupon_cell, coupon_list, datetime_picker, depreciate, dialog, divider, dropdown_item, dropdown_menu, empty, evaluate, es_field, es_form, goods_action, goods_action_button, goods_action_icon, grid, grid_item, es_icon, es_image, image_preview, index_anchor, index_bar, es_info, es_list, es_loading, locale["a" /* default */], nav_bar, nav_search, notice_bar, notify, number_keyboard, es_overlay, pagination, panel, password_input, picker, popup, popup_sp, es_progress, pull_refresh, pulldown_sort, es_radio, radio_group, es_rate, row, safeguard, search, share_sheet, sidebar, sidebar_item, skeleton, es_sku, slider, es_step, stepper, steps, es_sticky, submit_bar, swipe, swipe_cell, swipe_item, es_switch, switch_cell, tab, tabbar, tabbar_item, tabs, es_tag, es_toast, tooltip, top_nav_bar, tree_select, uploader, work_card, work_list, work_tab, work_tab_filter, work_tab_filter_item, work_tab_sort, work_tab_sort_item, work_tabs];
