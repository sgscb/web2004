...
exports.BackToTop = _backToTop.default;

var _bottombar = _interopRequireDefault(require("./bottombar"));

exports.Bottombar = _bottombar.default;

var _bottombarButton = _interopRequireDefault(require("./bottombar-button"));

exports.BottombarButton = _bottombarButton.default;

var _bottombarIcon = _interopRequireDefault(require("./bottombar-icon"));

exports.BottombarIcon = _bottombarIcon.default;

var _bottombarInfo = _interopRequireDefault(require("./bottombar-info"));

exports.BottombarInfo = _bottombarInfo.default;
...
exports.CenterPopup = _centerPopup.default;
...
var _depreciate = _interopRequireDefault(require("./depreciate"));

exports.Depreciate = _depreciate.default;
...
var _navSearch = _interopRequireDefault(require("./nav-search"));

exports.NavSearch = _navSearch.default;
...
var _popupSp = _interopRequireDefault(require("./popup-sp"));

exports.PopupSp = _popupSp.default;
...
var _pulldownSort = _interopRequireDefault(require("./pulldown-sort"));

exports.PulldownSort = _pulldownSort.default;
...
var _safeguard = _interopRequireDefault(require("./safeguard"));

exports.Safeguard = _safeguard.default;
...
var _topNavBar = _interopRequireDefault(require("./top-nav-bar"));

exports.TopNavBar = _topNavBar.default;
...
var _workCard = _interopRequireDefault(require("./work-card"));

exports.WorkCard = _workCard.default;

var _workList = _interopRequireDefault(require("./work-list"));

exports.WorkList = _workList.default;

var _workTab = _interopRequireDefault(require("./work-tab"));

exports.WorkTab = _workTab.default;

var _workTabFilter = _interopRequireDefault(require("./work-tab-filter"));

exports.WorkTabFilter = _workTabFilter.default;

var _workTabFilterItem = _interopRequireDefault(require("./work-tab-filter-item"));

exports.WorkTabFilterItem = _workTabFilterItem.default;

var _workTabSort = _interopRequireDefault(require("./work-tab-sort"));

exports.WorkTabSort = _workTabSort.default;

var _workTabSortItem = _interopRequireDefault(require("./work-tab-sort-item"));

exports.WorkTabSortItem = _workTabSortItem.default;

var _workTabs = _interopRequireDefault(require("./work-tabs"));

exports.WorkTabs = _workTabs.default;
var version = '2.21.4';
exports.version = version;

function install(Vue) {
  var components = [_actionSheet.default, _addressEdit.default, _addressList.default, _area.default, _backToTop.default, _bottombar.default, _bottombarButton.default, _bottombarIcon.default, _bottombarInfo.default, _button.default, _calendar.default, _card.default, _cell.default, _cellGroup.default, _centerPopup.default, _checkbox.default, _checkboxGroup.default, _circle.default, _col.default, _collapse.default, _collapseItem.default, _contactCard.default, _contactEdit.default, _contactList.default, _countDown.default, _coupon.default, _couponCell.default, _couponList.default, _datetimePicker.default, _depreciate.default, _dialog.default, _divider.default, _dropdownItem.default, _dropdownMenu.default, _empty.default, _evaluate.default, _field.default, _form.default, _goodsAction.default, _goodsActionButton.default, _goodsActionIcon.default, _grid.default, _gridItem.default, _icon.default, _image.default, _imagePreview.default, _indexAnchor.default, _indexBar.default, _info.default, _list.default, _loading.default, _locale.default, _navBar.default, _navSearch.default, _noticeBar.default, _notify.default, _numberKeyboard.default, _overlay.default, _pagination.default, _panel.default, _passwordInput.default, _picker.default, _popup.default, _popupSp.default, _progress.default, _pullRefresh.default, _pulldownSort.default, _radio.default, _radioGroup.default, _rate.default, _row.default, _safeguard.default, _search.default, _shareSheet.default, _sidebar.default, _sidebarItem.default, _skeleton.default, _sku.default, _slider.default, _step.default, _stepper.default, _steps.default, _sticky.default, _submitBar.default, _swipe.default, _swipeCell.default, _swipeItem.default, _switch.default, _switchCell.default, _tab.default, _tabbar.default, _tabbarItem.default, _tabs.default, _tag.default, _toast.default, _tooltip.default, _topNavBar.default, _treeSelect.default, _uploader.default, _workCard.default, _workList.default, _workTab.default, _workTabFilter.default, _workTabFilterItem.default, _workTabSort.default, _workTabSortItem.default, _workTabs.default];
